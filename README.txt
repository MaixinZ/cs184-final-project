...
Purpose
-------
This branch contains the ReShade FX implementation for a CS284A final project on
...
All project files described below use paths relative to the repository root. README files should not contain machine-specific absolute paths.

Folder layout
-------------
- shaderCyber/reshade-shaders/Shaders/Custom/
  - Project shaders, split controllers, auxiliary stages, and legacy files.
- shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/
  - Library-mode wrappers used by the split pipeline.
- shaderCyber/reshade-shaders/Shaders/ReShade.fxh
  - ReShade-provided include file required by the current custom shaders.
- shaderCyber/reshade-shaders/Shaders/ReShadeUI.fxh
...
- shaderCyber/reshade-shaders/Shaders/ReShade.fxh is provided by ReShade, not authored by the project, but it
...
- Painter is kept as a selectable slot in the new controller, but it is not one of
  the final project-authored shaders. The related files are shaderCyber/reshade-shaders/Shaders/Custom/painter.fx,
  shaderCyber/reshade-shaders/Shaders/Custom/painter_append.fx, and
  shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/painter_append_shared.fxh.
...
1. Oil Paint
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/oilPaint.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/oilPaint_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/oilPaint_append_shared.fxh
...
2. Red-green Color Assistance
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/slider.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/slider_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/slider_append_shared.fxh
...
3. Black Ink
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/black-ink.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/black-ink_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/black-ink_append_shared.fxh
...
4. Celluloid
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/celluloid.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/celluloid_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/celluloid_append_shared.fxh
...
5. Pixel Art
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/pixelArt.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/pixelArt_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/pixelArt_append_shared.fxh
...
1. Myopia Depth Blur
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/MyopiaDepthBlur.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/MyopiaDepthBlur_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/MyopiaDepthBlur_append_shared.fxh
...
2. Hyperopia Depth Blur
   - Standalone: shaderCyber/reshade-shaders/Shaders/Custom/HyperopiaDepthBlur.fx
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/HyperopiaDepthBlur_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/HyperopiaDepthBlur_append_shared.fxh
...
3. Silver Depth Edge
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/SilverDepthEdge_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/SilverDepthEdge_append_shared.fxh
...
4. Near Bright Far Dark
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/NearBrightFarDark_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/NearBrightFarDark_append_shared.fxh
...
5. Depth Band Assist
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/DepthBandAssist_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/DepthBandAssist_append_shared.fxh
...
6. Atmospheric Depth Cue
   - Append stage: shaderCyber/reshade-shaders/Shaders/Custom/AtmosphericDepthCue_append.fx
   - Split wrapper: shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/AtmosphericDepthCue_append_shared.fxh
...
-------------------------
The current report pipeline uses shaderCyber/reshade-shaders/Shaders/Custom/SplitScreenController_new.fx. It
...
SSB_ApplyEffect(...) in shaderCyber/reshade-shaders/Shaders/Custom/SplitStackEffects_new.fxh.
...
- *_append.fx files expose both standalone append techniques and ApplyFromSampler
  functions.
- shaderCyber/reshade-shaders/Shaders/Custom/AppendShared/*.fxh wrappers include append shaders in library mode for the split
...
---------------------------
The code in shaderCyber/reshade-shaders/Shaders/Custom/ is project-authored for this CS284A project. The final
...
Related READMEs
---------------
- shaderCyber/reshade-shaders/Shaders/Custom/SplitScreenController_README.txt
  - Details the current split-screen controller and multi-shader branch pipeline.
- shaderCyber/reshade-shaders/Shaders/Custom/DepthAssistShaders_README.txt
